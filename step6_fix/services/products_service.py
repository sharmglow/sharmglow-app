...
class ProductsService:
    ...
    def get_marketplace_map(self, product_id):
        return self.db.get_product_marketplace_map(product_id)

    def get_marketplace_bindings(self, product_id):
        return self.db.get_product_marketplace_bindings(product_id)

    def save_marketplace_bindings(self, product_id, bindings):
        return self.db.save_product_marketplace_bindings(product_id, bindings)
